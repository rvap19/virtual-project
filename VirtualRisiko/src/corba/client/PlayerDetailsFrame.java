...
public class PlayerDetailsFrame extends javax.swing.JFrame {
    ...
    public PlayerDetailsFrame(RisikoServer server){
        this();
        this.server=server;
    }
    ...
    private void initComponents() {
        ...
        messageLabel.setFont(new java.awt.Font("Bodoni MT Black", 0, 14)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(messageLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!this.server.checkUsername(username)){
            this.messageLabel.setText("username non disponibile");
            return;
        }else{
            this.messageLabel.setText("");
        }
        ...
        if(pwd1==null||pwd1.equals("")){
            this.messageLabel.setText("inserire password");
            return;
        }
        String pwd2=this.passwordField2.getText();
        if(pwd2==null||pwd2.equals("")){
            this.messageLabel.setText("ripetere password");
            return;
        }
        if(!pwd1.equals(pwd2)){
           this.messageLabel.setText("le password non coincidono ");
           return;
        }

        String email=this.emailText.getText();
        if(email==null||email.equals("")){
            this.messageLabel.setText("inserire email");
            return;
        }

        String nome=this.nomeText.getText();
        if(nome==null||nome.equals("")){
            this.messageLabel.setText("inserire nome");
            return;
        }

        String cognome=this.cognomeText.getText();
        if(cognome==null||cognome.equals("")){
            this.messageLabel.setText("inserire cognome");
            return;
        }
        
        UserDetails details=new UserDetails(username, pwd2, email, nome, cognome, "");
        if(server.createUser(details)){
            this.messageLabel.setText("il tuo codice di registrazione è stato inviato a "+email);
        }
        try {
            Thread.sleep(1 * 1500);
            this.dispose();
        } catch (InterruptedException ex) {
            Logger.getLogger(PlayerDetailsFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlayerDetailsFrame().setVisible(true);
            }
        });
    }
