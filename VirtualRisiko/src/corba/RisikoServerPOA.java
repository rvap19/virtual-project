 ...
 implements corba.RisikoServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("createUser", new java.lang.Integer (10));
    _methods.put ("checkUsername", new java.lang.Integer (11));
    _methods.put ("activateUser", new java.lang.Integer (12));
    _methods.put ("sendEmailForPassword", new java.lang.Integer (13));
    _methods.put ("getStatistics", new java.lang.Integer (14));
    _methods.put ("getCompleteStatistics", new java.lang.Integer (15));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 10:  // corba/RisikoServer/createUser
       {
       ...
       case 11:  // corba/RisikoServer/checkUsername
       {
         String username = in.read_wstring ();
         boolean $result = false;
       ...
       case 12:  // corba/RisikoServer/activateUser
       {
         String username = in.read_wstring ();
       ...
       case 13:  // corba/RisikoServer/sendEmailForPassword
       {
         corba.UserInfo user = corba.UserInfoHelper.read (in);
         boolean $result = false;
       ...
       case 14:  // corba/RisikoServer/getStatistics
       {
         String username = in.read_wstring ();
       ...
       case 15:  // corba/RisikoServer/getCompleteStatistics
       {
