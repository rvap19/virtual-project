 ...
 */
 ...
 @RunWith(JMock.class)
public class ControllerJmockTest2 {
   ...
   */
     ...
     public void testNotifyApplianceJMock() throws Exception
	 {
         ...
         final Giocatore giocatore=tavolo.getGiocatori().get(1);
         ...
         final int truppe=1;
          final String message="Il giocatore giallo posiziona 1 in "+m.getTerritorio(territorioID).getNome()+" -> ERRORE :: turno 0 tavolo in init? true";
