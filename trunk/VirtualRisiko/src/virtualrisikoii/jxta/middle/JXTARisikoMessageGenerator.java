...
public class JXTARisikoMessageGenerator extends RisikoMessageGenerator{
    ...
    public AckMessage generateAckMSG(int ack_message_id) {
         AckMessage ack=new virtualrisikoii.jxta.communication.messages.AckMessage(ack_message_id);
    ...
    public ApplianceMessage generateApplianceMSG(int region, int troopsNumber) {
        ApplianceMessage app= new virtualrisikoii.jxta.communication.messages.ApplianceMessage(troopsNumber, region);
    ...
    public AttackMessage generateAttackMSG(int from, int to, int troopsNumber) {
        AttackMessage attack= new virtualrisikoii.jxta.communication.messages.AttackMessage(troopsNumber, to, from);
    ...
    public ChangeCardMessage generateChangeCardMSG(int c1, int c2, int c3) {
        ChangeCardMessage ccm= new virtualrisikoii.jxta.communication.messages.ChangeCardMessage(c1, c2, c3);
    ...
    public ChatMessage generateChatMSG(String from, String to, String message) {
        ChatMessage cm= new virtualrisikoii.jxta.communication.messages.ChatMessage(to, from, message);
    ...
    public ElectionMessage generateElectionMSG(String peedID, int currentTurn) {
        ElectionMessage em= new virtualrisikoii.jxta.communication.messages.ElectionMessage(peedID, currentTurn);
    ...
    public ElectionRequestMessage generateElectionRequestMSG() {
        ElectionRequestMessage erm= new virtualrisikoii.jxta.communication.messages.ElectionRequestMessage();
    ...
    public MovementMessage generateMovementMSG(int from, int to, int troopsNumber) {
        MovementMessage mm= new virtualrisikoii.jxta.communication.messages.MovementMessage(troopsNumber, from, to);
    ...
    public PassMessage generatePassMSG(int turno_successivo) {
        PassMessage pm= new virtualrisikoii.jxta.communication.messages.PassMessage(turno_successivo);
    ...
    public PingMessage generatePingMSG() {
        PingMessage pm= new virtualrisikoii.jxta.communication.messages.PingMessage();
        pm.setPlayerName(playerName);
        return pm;
    }
    ...
    public PongMessage generatePongMSG(String peerID) {
        PongMessage pm= new virtualrisikoii.jxta.communication.messages.PongMessage(peerID);
        pm.setPlayerName(playerName);
        return pm;
    }
    ...
    public RecoveryMessage generateRecoveryMSG(RecoveryParameter parameter) {
        RecoveryMessage rm= new virtualrisikoii.jxta.communication.messages.RecoveryMessage(parameter);
    ...
    public RetrasmissionRequestMessage generateRetrasmissionRequestMSG(int msgID) {
        RetrasmissionRequestMessage rrm= new virtualrisikoii.jxta.communication.messages.RetrasmissionRequest(msgID);
    ...
    public StatusPeerMessage generateStatusPeerMSG(int peerID, boolean isOnline) {
        StatusPeerMessage spm= new virtualrisikoii.jxta.communication.messages.StatusPeerMessage(peerID, isOnline);
    ...
    public WelcomeMessage generateWelcomeMSG(String playerUsername) {
        WelcomeMessage wm= new virtualrisikoii.jxta.communication.messages.WelcomeMessage(playerName);
    ...
    public InitMessage generateInitMSG(List<String> userNames, GameParameter parameter) {
        InitMessage im= new virtualrisikoii.jxta.communication.messages.InitMessage(parameter, userNames);
