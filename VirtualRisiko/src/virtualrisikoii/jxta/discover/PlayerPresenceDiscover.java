...
package virtualrisikoii.jxta.discover;
...
import virtualrisikoii.jxta.advertisement.JXTADiscoveryResponseMsg;
import virtualrisikoii.jxta.advertisement.JXTAPipeAdvertisement;
import virtualrisikoii.jxta.advertisement.JXTARisikoDiscoveryEvent;
import virtualrisikoii.jxta.advertisement.PlayerAdvertisement;
import net.jxta.protocol.PipeAdvertisement;
import virtualrisikoii.jxta.communication.JXTAPeerGroup;
    ...
    public void discoveryEvent(DiscoveryEvent TheDiscoveryEvent) {
        ...
        if (TheDiscoveryResponseMsg!=null) {
            ...
            while (TheEnumeration.hasMoreElements()) {
                ...
                try {   
                    if(adv.getAdvType().equalsIgnoreCase(virtualrisikoii.jxta.advertisement.PlayerAdvertisement.getAdvertisementType())){
        ...
        if (discovery != null)
        {
             presenceInfo = (PlayerAdvertisement)
                AdvertisementFactory.newAdvertisement(
                    virtualrisikoii.jxta.advertisement.PlayerAdvertisement.getAdvertisementType());
