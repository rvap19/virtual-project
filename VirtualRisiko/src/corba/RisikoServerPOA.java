 ...
 implements corba.RisikoServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("saveResult", new java.lang.Integer (4));
    _methods.put ("createGame", new java.lang.Integer (5));
    _methods.put ("signPlayer", new java.lang.Integer (6));
    _methods.put ("getAuthenticateUsers", new java.lang.Integer (7));
    _methods.put ("getPlayers", new java.lang.Integer (8));
    _methods.put ("shutdown", new java.lang.Integer (9));
    _methods.put ("getPartitaInfo", new java.lang.Integer (10));
    _methods.put ("getActiveGame", new java.lang.Integer (11));
    _methods.put ("notifyNewManager", new java.lang.Integer (12));
    _methods.put ("createUser", new java.lang.Integer (13));
    _methods.put ("checkUsername", new java.lang.Integer (14));
    _methods.put ("activateUser", new java.lang.Integer (15));
    _methods.put ("sendEmailForPassword", new java.lang.Integer (16));
    _methods.put ("getStatistics", new java.lang.Integer (17));
    _methods.put ("getCompleteStatistics", new java.lang.Integer (18));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // corba/RisikoServer/saveResult
       {
       ...
       case 5:  // corba/RisikoServer/createGame
       {
       ...
       case 6:  // corba/RisikoServer/signPlayer
       {
       ...
       case 7:  // corba/RisikoServer/getAuthenticateUsers
       {
         corba.UserInfo $result[] = null;
       ...
       case 8:  // corba/RisikoServer/getPlayers
       {
         corba.PartitaInfo partita = corba.PartitaInfoHelper.read (in);
         corba.UserInfo $result[] = null;
       ...
       case 9:  // corba/RisikoServer/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
       ...
       case 10:  // corba/RisikoServer/getPartitaInfo
       {
       ...
       case 11:  // corba/RisikoServer/getActiveGame
       {
         String username = in.read_wstring ();
         corba.PartitaInfo $result = null;
       ...
       case 12:  // corba/RisikoServer/notifyNewManager
       {
         corba.PartitaInfo partita = corba.PartitaInfoHelper.read (in);
       ...
       case 13:  // corba/RisikoServer/createUser
       {
       ...
       case 14:  // corba/RisikoServer/checkUsername
       {
         String username = in.read_wstring ();
         boolean $result = false;
       ...
       case 15:  // corba/RisikoServer/activateUser
       {
         String username = in.read_wstring ();
       ...
       case 16:  // corba/RisikoServer/sendEmailForPassword
       {
         corba.UserInfo user = corba.UserInfoHelper.read (in);
         boolean $result = false;
       ...
       case 17:  // corba/RisikoServer/getStatistics
       {
         String username = in.read_wstring ();
       ...
       case 18:  // corba/RisikoServer/getCompleteStatistics
       {
